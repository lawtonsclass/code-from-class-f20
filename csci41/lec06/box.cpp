...
class Box {
 public:
  ...
  Box& operator=(const Box& other) noexcept;  // noexcept means that this cannot
                                              // throw exceptions
...
Box& Box::operator=(const Box& other) noexcept {
  ...
  // if you don't have the self-assignment check, you might be
  // accessing memory that no longer belongs to you
